...
//________________________________________________________ 
  ...
  //________________________________________________________
    ...
    var restaurantInput = $(".restaurant_input").val();
    var theatresInput = $(".theatres_input").val();
    var localEvents = $(".localevents_input").val();
...
//__________________________________________________________
  ...
  //________________________________________________________
   ...
   $(".restaurant_input").on("click", function(){
    activityEntry.attr("value", restaurantInput )

   })

   $(".theatres_input").on("click", function(){
    activityEntry.attr("value", theatresInput )
   })

   $(".localevents_input").on("click", function(){
    activityEntry.attr("value",localEvents)
   })
